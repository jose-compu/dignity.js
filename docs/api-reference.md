<!-- Generated by scripts/generate-api-reference.js — do not edit by hand --># dignity.js API reference (v0.11.0)
...
- **`buildClientBootstrapScript`** — self-contained iframe bootstrap for connectDignityAppClient
...
Package version: **0.11.0** (spec 0.11.0).
