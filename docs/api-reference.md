<!-- Generated by scripts/generate-api-reference.js — do not edit by hand --># dignity.js API reference (v0.13.0)
...
| `warning` | orphan-operation, peer-connect-failed, presence failures, content-hash-mismatch, domain-event-rejected, tier-announce-failed |
...
Package version: **0.13.0** (spec 0.13.0).
