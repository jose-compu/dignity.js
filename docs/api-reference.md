<!-- Generated by scripts/generate-api-reference.js — do not edit by hand --># dignity.js API reference (v0.12.0)
...
- **`validateDignityAppManifest`** — validate manifest; returns { ok, manifest | reason }
...
- **`executeStoredCommand`** — run manifest-declared write on publisher node only
...
Package version: **0.12.0** (spec 0.12.0).
